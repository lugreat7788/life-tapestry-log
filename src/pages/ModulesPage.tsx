...
export default function ModulesPage() {
      ...
      {modules.map((mod, i) => {
        ...
        return (
          <motion.button
            ...
            transition={{ delay: (startIndex + i) * 0.03, duration: 0.25 }}
            ...
            className={cn(
              ...
              mod.bgClass,
              isBonus && "ring-1 ring-amber-300/40"
            )}
          >
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {completed}/{mod.items.length} 项 · {isBonus ? `+${earned}` : `${earned}分`}
            </p>
          </motion.button>
        );
      })}
  ...
  return (
    <div className="px-4 pt-6 pb-4 max-w-lg mx-auto">
      ...
      <h2 className="text-sm font-semibold text-amber-600 mt-6 mb-3 uppercase tracking-wider">
        ⭐ 成长加分（额外加分）
      </h2>
